...
searchButton.click(function () {
    ...
    if (searchInput == "") {
        ...
        $.ajax({
            ...
            var eventCard = $(".currentCard").append("<div>").addClass("card-body");
            eventCard.empty();
            var locationName = eventCard.append("<p>");
          
            eventCard.append(locationName);

          
            var timeUTC = new Date(response.dt * 1000);
            locationName.append(response.name + " " + timeUTC.toLocaleDateString("en-US"));
            locationName.append(`<img src="https://openweathermap.org/img/wn/${response.weather[0].icon}@2x.png">`);
           
            var currentTemp = locationName.append("<p>");
           
            locationName.append(currentTemp);
